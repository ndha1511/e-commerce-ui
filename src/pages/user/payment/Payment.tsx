                        ...
                        <Row className="bg-white  border-radius-small ">
                            ...
                            <Col md={6} className=' p-2 border-end'>
                                <div className="align-items-center">
                                    <div className=" w-100 " >
                                        <div onClick={() => setOpenMs(!openMs)} className={`d-flex justify-content-between pe-1 ${openMs ? 'mb-3':''}`}>
                            ...
                            <Col md={6} className=' p-2'>
                                <div onClick={() => setOpenShip(!openShip)} className={`d-flex justify-content-between ${(openShip && mobile) ? 'mb-3':''}  pe-1`}>
                    ...
                    <div className=' p-3 bg-white  border-radius-small mb-3'>
                        <div>
                            ...
                            <div className='d-flex mt-3 mb-3'>
                                <button className={`payment-button ${paymentMethod === PaymentMethod.COD ? 'active' : ''}  me-3`}
                                    onClick={() => setPaymentMethod(PaymentMethod.COD)}
                                >
                                    Thanh toán khi nhận hàng
                                </button>
                                <button className={`payment-button ${paymentMethod === PaymentMethod.ATM ? 'active' : ''}  me-3`} onClick={() => setPaymentMethod(PaymentMethod.ATM)}
                                >
                ...
                <Col md={4} className=''>
                    <div className='p-3 bg-white shadow-all border-radius-small '>
                        ...
                        <div className="p-3 bg-white border rounded">
                            ...
                            <button
                                disabled={(address?.data && address?.data.length > 0) ? false : true}
                                onClick={handlerOrder}
                                className="w-100 button-flex button-hover background-primary text-large"
                                style={{ border: 'none', opacity: (address?.data && address?.data.length > 0) ? 1 : 0.5 }}>Đặt hàng</button>
                        </div>
                    </div>
                </Col>
            </Row>
