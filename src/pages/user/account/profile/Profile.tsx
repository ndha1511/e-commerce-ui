  ...
  return (
    <div className="profile-container ">
      ...
      <div className="d-flex w-100 profile-content flex-wrap ">
        <Form
          className={`col-12 col-md-6 ${isBtn ? "" : "pointer-events-none"}  `}
        >
        ...
        <div className="col-12 col-md-6 d-flex align-items-center justify-content-center flex-column gap-2">
          ...
          <label
            htmlFor="avatar"
            className="button-flex1 button-hover  text-medium gap-2 "
          ...
          <span style={{ textAlign: "center" }}>
            Dung lượng tối đa 1MB <br></br> Định dạng jpg, png
          </span>
        </div>
      </div>
