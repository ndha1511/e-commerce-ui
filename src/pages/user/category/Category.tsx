...
function Category() {
  ...
  const images = [
    {
      src: [
        "https://salt.tikicdn.com/ts/tka/a9/ec/4f/e95b916999b2dd40b3a8e2af30e704e8.png",
        "https://salt.tikicdn.com/ts/tka/99/ce/6a/9c0a7990ddba5207da7cc37b85bdc2f0.png",
      ],
      alt: "First slide",
    ...
    {
      src: [
        "https://salt.tikicdn.com/ts/tka/45/7b/70/fb7c0e1414d55ae6ea43af2883f2d842.png",
        "https://salt.tikicdn.com/ts/tka/7f/0b/d3/95916a0bd08a84d64206ce6ef9e72010.png",
      ],
      alt: "Second slide",
  ...
  useEffect(() => {
    if (parentCategory?.data) {
      ...
      setBreadcrumb((prevBreadcrumb) => {
        const isCategoryExist = prevBreadcrumb.some(
      ...
      <div className="p-3 bg-light">
        ...
        <Row className=" custom-row p-2 ">
          ...
          <Col md={10} className="p-2">
            <div className="mb-2">
              <SkeletonWrapper
                queriesStatus={[getProductsSuccess]}
                skHeight={200}
              >
