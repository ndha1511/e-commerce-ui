      ...
      {isVisible && (
        ...
        >
          <AnimatePresence>
            ...
            >
              <div
                className="border-bottom p-2 mb-1 text-black "
                style={{ fontSize: 12 }}
              >
                Thông báo
              </div>
                ...
                {notifications
                  ...
                  .map((notification) => {
                    ...
                    return (
                      <div
                        key={notification.id}
                        className="content-notificaton"
                        style={{
                          backgroundColor:
                            notification.seen === true
                              ? ""
                              : "rgba(225, 220, 220, 0.3)",
                        }}
                      ...
                      >
                        ...
                        <div>
                          ...
                          <div className="d-flex flex-column gap-1">
                            <span className="text-light-cs">
                              {notification.content}
                            </span>
                            <span
                              className="text-light-cs"
                              style={{ fontSize: 10 }}
                            >
                              {timestamp}
                            </span>
