    ...
    <div className="w-100 container-fluid">
      <Row>
        <Col md={12} xs={12} className="border bg-light p-3">
          <div
            className="bg-white p-4 border-radius-medium"
            style={{ width: "100%" }}
          >
            ...
            <div className="d-flex flex-column gap-4">
              ...
              <Row>
                <Col md={2} className="text-end">
                  <div className="mt-2">
                    {" "}
                    <span>
                      <span className="primary">*</span> Tên sản phẩm :
                    </span>
                  </div>
                </Col>
                <Col md={10}>
                  ...
                  >
                    <input
                      className={`input-basic-information-seller ${
                        productName.trim() === "" && addProductClick
                          ? "border-err"
                          : ""
                      }`}
                      ...
                      placeholder="Tên sản phẩm + Thương hiệu + Model"
                      type="text"
                    />
                  </OverlayTrigger>
                </Col>
              ...
              <Row>
                <Col md={2} className="text-end">
                  <div className="mt-2">
                    <span>
                      <span className="primary">*</span> Ngành hàng:
                    </span>
                  </div>
                </Col>
                <Col md={10}>
                  ...
                  >
                    <div
                      className={`category-seller `}
                      onClick={handleOpenCategoryModal}
                    >
                      <input
                        readOnly
                        className={`input-basic-information-seller ${
                          category?.trim() === "" && addProductClick
                            ? "border-err"
                            : ""
                        }`}
                        value={category || ""}
              ...
              <PromotionRow label="Thương hiệu">
                <OverlayTrigger
                  placement="bottom"
                  overlay={
                    selectedBrand.name?.trim() === "" || checkCategory ? (
                      CustomTooltip(
                        checkCategory
                  ...
                  show={
                    (selectedBrand.name?.trim() === "" && addProductClick) ||
                    checkCategory
                  }
                >
              ...
              <Row>
                <Col md={2} className="text-end">
                  <div className="mt-2">
                    <span>
                      <span className="primary">*</span>Giá:
                    </span>
                  </div>
                </Col>
                <Col md={10}>
                  ...
                  >
                    <div
                      className={`select-search-sale-info ${
                        regularPrice === 0 && addProductClick
                          ? "border-err"
                          : ""
                      }`}
                    >
              ...
              <Row>
                <Col md={2} className="text-end">
                  <div className="mt-2">
                    <span>
                      <span className="primary">*</span>Cân nặng:
                    </span>
                  </div>
                </Col>
                <Col md={10}>
                  ...
                  >
                    <div
                      className={`select-search-sale-info ${
                        weight === null && addProductClick ? "border-err" : ""
                      }`}
                    >
                      <div
                        className=" p-2"
              ...
              <Row>
                <Col md={2} className="text-end">
                  <div className="mt-2">
                    <span>
                      <span className="primary">*</span> Mô tả sản phẩm:
                    </span>
                  </div>
                </Col>
                <Col md={10}>
            ...
            <div className=" mt-3 w-100 d-flex justify-content-end">
              <button
                className="btn-save-all-category-1"
                onClick={() => {
                  handleAddProduct();
                  handleClickAdd();
                }}
