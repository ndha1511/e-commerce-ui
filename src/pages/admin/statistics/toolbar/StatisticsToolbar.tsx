...
import { formatDate, formatDate2, getStartAndEndOfMonth, getStartAndEndOfYear } from "../../../../utils/datetime";
...
const StatisticsToolbar: React.FC<SatisticsProps> = (props) => {
    ...
    const setMonthYear = (date: string) => {
        const { startOfMonthString, endOfMonthString } = getStartAndEndOfMonth(date);
        setSearch((prev: SatisticsSearch) =>{
            return {
                ...prev,
                monthYear: date,
    ...
    const setYear = (date: string) => {
        const {startOfYearString, endOfYearString} = getStartAndEndOfYear(Number(formatDate2(date, "yyyy")));
        setSearch((prev: SatisticsSearch) =>{
            return {
                ...prev,
    ...
    return <div className="d-flex flex-column gap-2">
        <div className="d-flex gap-2 align-items-center">
            ...
            <Select options={modeOptions} value={modeOptions.find(option => option.value === mode)} onChange={
                (value) => {
